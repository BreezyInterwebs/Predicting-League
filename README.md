...
For my significance level, I've decided to use `alpha` = 0.01. While `alpha` = 0.05 is a rule of thumb, I feel that 1/20 is too common of a chance to reject the null. Hence, 1/100 feels like a much more reasonable level to reject. We perform a modified version of permutation testing, and here we show a histogram of our results.
<iframe src="assets/permutation.html" width=800 height=600 frameBorder=0></iframe>

For this permutation test, our p-value is 0.025. Therefore, we'd fail to reject the null. It seems that our model most likely performs similarly for games in and out of playoffs.
